...
RUN chmod +x /home/$user/nodeUP && chmod 600 /home/$user/.nodes.myconfig && touch /home/$user/.bashrc && /home/$user/nodeUP
...
# use docker create -it and then docker start after build
